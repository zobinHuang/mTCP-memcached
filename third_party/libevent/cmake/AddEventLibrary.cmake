...
macro(add_event_library LIB_NAME)
    ...
    if (${EVENT_LIBRARY_STATIC})
        ...
        target_include_directories("${LIB_NAME}_static" PUBLIC ${PATH_HDR_MCTP})
        target_link_libraries("${LIB_NAME}_static" LIB_MTCP)
        target_link_libraries("${LIB_NAME}_static" ${DPDK_LDFLAGS})
        target_link_libraries("${LIB_NAME}_static" -lpthread -lm -lgmp)
    ...
    if (${EVENT_LIBRARY_SHARED})
        ...
        target_include_directories("${LIB_NAME}_shared" PUBLIC ${PATH_HDR_MCTP})
        target_link_libraries("${LIB_NAME}_shared" ${LIB_MTCP})
        target_link_libraries("${LIB_NAME}_shared" ${DPDK_LDFLAGS})
        target_link_libraries("${LIB_NAME}_shared" -lpthread -lm -lgmp)
